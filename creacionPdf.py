...
global identificadorPdf
def main():
    root = Tk()
    root.title('Prueba PDF')
    root.geometry("500x500")

    botonImprimir = Button(root,text='Generar PDF',command=crearPdf)
    botonImprimir.place(x=10,y=10)
    root.mainloop()
...
lista_datos = (('BODEGA CENTRAL','03262082182','ARNES PARA CASCO','UNICA','2','2023-01-18'),
                ('BODEGA CENTRAL','03196005201','CHALECO GEOLOGO SUPERVISOR BICOLOR','XL','1','2021-09-30'),
                ('BODEGA CS','03196052004','CHALECO GEOLOGO NARANJO','M','1','2022-05-25'),
                ('BODEGA T1A','03162600044','BOTAS PUNTERIA DE ACERO PLANT ANTIPERF','44','1','2019-05-22'),

)

def crearPdf():

        for identificadorPdf in range(0,5):
            ...
            pdf.cell(w=3,h=1,txt='CANTIDAD',border=1,align='C',fill=0)
            ...
            for valor in lista_datos:
                ...
                pdf.cell(w= 3,h= 1,txt=valor[4],border=1,align='C',fill=0)
