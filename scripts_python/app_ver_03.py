...
def main(usuario_id):
    ...
    label_empleado_vigencia_entrega_output_2.grid(row=9,column=0)    

    # info epp

    label_info_epp = Label(buscar_entregas, text='Info del EPP:')    
    label_info_epp.grid(row=10,column=0) 

    # id
    label_epp_id_entrega_2 = Label(buscar_entregas, text='ID:')
    label_epp_id_entrega_2.grid(row=6,column=0)

    label_epp_id_entrega_output_2 = Label(buscar_entregas, text='')
    label_epp_id_entrega_output_2.grid(row=6,column=1)

    # nombre
    label_epp_nombre_entrega_2 = Label(buscar_entregas, text='Nombre:')
    label_epp_nombre_entrega_2.grid(row=7,column=0)

    label_epp_nombre_entrega_output_2 = Label(buscar_entregas, text='')
    label_epp_nombre_entrega_output_2.grid(row=7,column=1)
    ...
    # listbox_entregas_2.grid(row=0, columnspan=14, sticky= W+E)      # se posiciona la listbox
